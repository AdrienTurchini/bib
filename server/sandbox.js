...
mr = 'https://www.maitresrestaurateurs.fr/annuaire/recherche';
...
async function sandbox (searchLink = maitre) {
  
  try {
    console.log(`🕵️‍♀️  browsing ${searchLink} source`);
    const restaurant = await maitrerestaurateurs.scrapeRestaurant(searchLink);
